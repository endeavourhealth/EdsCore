...
public class CassandraEmisCsvCodeMap {
    ...
    public CassandraEmisCsvCodeMap() {}
    
    public CassandraEmisCsvCodeMap(EmisCsvCodeMap proxy) {
        ...
        //this.timeUuid = proxy.; //the time UUID isn't part of the proxy object

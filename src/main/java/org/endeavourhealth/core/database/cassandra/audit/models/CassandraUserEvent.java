...
public class CassandraUserEvent {
    ...
    public CassandraUserEvent() {}

    public CassandraUserEvent(Row row) {
    ...
    public CassandraUserEvent(UUID userId, IAuditModule auditModule, IAuditModule auditSubModule, String action, UUID organisationId, String data) {
        this.userId = userId;

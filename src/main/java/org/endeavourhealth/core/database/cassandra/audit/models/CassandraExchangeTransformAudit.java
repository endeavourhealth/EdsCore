...
public class CassandraExchangeTransformAudit {
    ...
    public CassandraExchangeTransformAudit() {}

    public CassandraExchangeTransformAudit(ExchangeTransformAudit proxy) {

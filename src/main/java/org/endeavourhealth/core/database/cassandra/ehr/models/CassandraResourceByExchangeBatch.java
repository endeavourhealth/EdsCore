...
public class CassandraResourceByExchangeBatch {
    ...
    public CassandraResourceByExchangeBatch() {}

    public CassandraResourceByExchangeBatch(ResourceWrapper proxy) {
        this.batchId = proxy.getExchangeBatchId();

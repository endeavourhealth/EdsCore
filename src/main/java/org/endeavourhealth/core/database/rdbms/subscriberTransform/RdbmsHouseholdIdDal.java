...
import org.endeavourhealth.core.database.rdbms.subscriberTransform.models.RdbmsHouseholdIdMap;
...
public class RdbmsHouseholdIdDal implements HouseholdIdDalI {

    private String subscriberConfigName = null;

    public RdbmsHouseholdIdDal(String subscriberConfigName) {
        this.subscriberConfigName = subscriberConfigName;
    }

    public Long findOrCreateHouseholdId(Address address) throws Exception {
    ...
    private static Long createHouseholdId(String postcode, String line1, String line2, EntityManager entityManager) {
        ...
        RdbmsHouseholdIdMap mapping = new RdbmsHouseholdIdMap();
    ...
    private static Long findHouseholdId(String postcode, String line1, String line2, EntityManager entityManager) {
        ...
        String sql = "select c"
                + " from"
                + " RdbmsHouseholdIdMap c"
                + " where c.postcode = :postcode"
                + " and c.line1 = :line1"
                + " and c.line2 = :line2";


        Query query = entityManager.createQuery(sql, RdbmsHouseholdIdMap.class)
                .setParameter("postcode", postcode)
                .setParameter("line1", line1)
                .setParameter("line2", line2);

        try {
            RdbmsHouseholdIdMap result = (RdbmsHouseholdIdMap)query.getSingleResult();

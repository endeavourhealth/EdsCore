...
public class RdbmsExchangeBatchExtraResourcesDal implements ExchangeBatchExtraResourceDalI {
    ...
    public void saveExtraResource(UUID exchangeId, UUID batchId, String resourceType, UUID resourceId) throws Exception {
    ...
    public Map<String, List<UUID>> findExtraResources(UUID exchangeId, UUID batchId) throws Exception {

...
public class TransformErrorUtility {
    ...
    public static final String ARG_AUTO_FAILED = "AutoFailed";

    //subscriberTransform-specific arguments
     ...
     */
    private static Error createError(Throwable ex, Map<String, String> args) {
        Error ret = new Error();
